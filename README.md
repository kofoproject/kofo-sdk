# KOFO SDK
KOFO cross chain atomic exchange，Currently supporting **`BTC`** **`USDT`** **`ETH/ERC20`** **`HPB`**  **`TRON`** **`ZILLIQA`** **`EOS`** **`BOS`** **`MEETONE`** **`BNB`**
## Install and import
...
<script src="https://pre.kofo.io/kofo/kofosdk.js"></script>
