 ...
 */
Kofo.prototype.signatureCallback = function (type, chain, currency, settlementId, signedRawTransaction, pubKey) {
    try {
        ...
        signatureHandler.call(signatureCallback, roleEnum, settlementId, signedRawTransaction, pubKey);
    } catch (error) {
        console.log(error)
    }
