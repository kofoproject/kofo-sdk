...
class EosGateway extends Connection {
    ...
    async sendLockTx({settlementId, lockId, rawTransaction, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.EOS}) {
    ...
    async sendWithdrawTx({settlementId, rawTransaction, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.EOS}) {
    ...
    async sendRefundTx({settlementId, rawTransaction, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.EOS}) {
