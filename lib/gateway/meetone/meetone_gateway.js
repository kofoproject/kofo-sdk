...
class MeetOneGateway extends Connection {
    constructor(options) {
        super(options);
    }
    ...
    async sendLockTx({settlementId, lockId, rawTransaction, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.MEETONE}) {
    ...
    async sendWithdrawTx({settlementId, rawTransaction, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.MEETONE}) {
    ...
    async sendRefundTx({settlementId, rawTransaction, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.MEETONE}) {
