...
class MeetOneGateway extends Connection {
    ...
    async sendLockTx({settlementId, lockId, rawTransaction, signList, confirmThreshold = CONFIRM_THRESHOLD.MEETONE}) {
    ...
    async sendWithdrawTx({settlementId, rawTransaction, signList, confirmThreshold = CONFIRM_THRESHOLD.MEETONE}) {
    ...
    async sendRefundTx({settlementId, rawTransaction, signList, confirmThreshold = CONFIRM_THRESHOLD.MEETONE}) {
