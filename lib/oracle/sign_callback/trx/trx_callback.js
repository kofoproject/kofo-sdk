...
/**
 * Provides TRX with Hash lock, Withdraw, Refund, Approve signature callback handler
 */
class TrxSignatureCallback extends Oracle {
    ...
    async hashLockTxSignCallback(roleEnum, settlementId, signedRawTransaction) {
        const _self = this;
        _self.logger.info(`TRX ${roleEnum} ${settlementId} hashLockTxSign sign_callback params: `, signedRawTransaction);
    ...
    async withdrawTxSignCallback(roleEnum, settlementId, signedRawTransaction) {
        const _self = this;
        _self.logger.info(`TRX ${roleEnum} ${settlementId} withdrawTxSign sign_callback params: `, signedRawTransaction);
    ...
    async refundTxSignCallback(roleEnum, settlementId, signedRawTransaction) {
        const _self = this;
        _self.logger.info(`TRX ${roleEnum} ${settlementId} refundTxSignCallback sign_callback params: `, signedRawTransaction);
...
module.exports = TrxSignatureCallback;