...
class TrxOracle extends Oracle {
    ...
    async submitHashLockTxHandler(message) {
        ...
        const _self = this;
        _self.logger.info(`TRX ${roleEnum} submitHashLockTx ${settlementId}`);
    ...
    async submitWithdrawTxHandler(message) {
        ...
        _self.logger.info(`TRX ${roleEnum} submitWithdrawTx ${settlementId}`);
    ...
    async submitRefundTxHandler(message) {
        ...
        _self.logger.info(`TRX ${roleEnum} submitRefundTx ${settlementId}`);
