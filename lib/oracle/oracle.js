...
class Oracle {
    ...
    async createRefundHandler(message) {
        ...
        if (!hasLocker) {
            ...
            throw new TypeError(`Not read cache hashLocker flow ${hasLocker}`);
        }
    }
    ...
    formatSettlement(roleEnum, settlementData) {
        ...
        const fields = ['Amount', 'Chain', 'CounterChainPubKey', 'Currency', 'Locktime', 'PubKey', 'ConfirmThreshold',  'Fee', 'AdminPubKey'];
