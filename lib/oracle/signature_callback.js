...
class BtcSignatureCallback extends BaseOracle {
    ...
    async hashLockTxSignCallback(roleEnum, settlementId, signedRawTransaction) {
        ...
        const {chain, currency, amount, pubKey, confirmThreshold, addressType} = _self.formatSettlement(roleEnum, settlementInfo);
    ...
    async withdrawTxSignCallback(roleEnum, settlementId, signedRawTransaction) {
        ...
        const {oppositeChain: chain, oppositeCurrency: currency, counterChainPubKey: pubKey, oppositeConfirmThreshold: confirmThreshold, oppositeAdminPubKey: adminPubKey, counterChainAddressType} = _self.formatSettlement(roleEnum, settlementInfo);
    ...
    async refundTxSignCallback(roleEnum, settlementId, signedRawTransaction) {
        ...
        const {chain, currency, pubKey: sender, confirmThreshold, adminPubKey, addressType} = _self.formatSettlement(roleEnum, settlementInfo);
